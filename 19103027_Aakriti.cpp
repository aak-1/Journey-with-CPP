...
float cycle(float d) {
  fem = sin(age * 6.2831 / 28);
  fph = sin(age * 6.2831 / 23);
  fin = sin(age * 6.2831 / 33);
  ...
  case 1:
    {
      ...
      if (bmi <= 19) {
        cout << name << ", you are underweight and your bmi is " << bmi << endl;
      } else if (bmi >= 19 && bmi <= 24) {
        cout << name << ", you are normal and your bmi is " << bmi << endl;
      } else if (bmi >= 24 && bmi <= 29) {
        cout << name << ", you are overweight and your bmi is " << bmi << endl;
      } else {
        cout << name << ", you are obese and your bmi is " << bmi << endl;
      }
    }
    break;
